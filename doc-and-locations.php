...
<main style="min-height: calc(100vh - 176px - 104px);">
    <h1 class="font-semibold leading-tight text-5xl mt-0 mb-2 text-grey-600 bold text-center mt-10">Find Doctors and
        Locations</h1>
    ...
    <div class="flex items-center justify-center mb-10 scale-125">
        <div class="border-2 border-black bg-slate-900 basis-3/12 text-white rounded-lg mt-10 px-10 py-3">
            <p>Enter your city name to find avaiable doctors. Leave text field empty if you wish to view all doctors in
                every location.</p>
        </div>
    </div>
