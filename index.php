        ...
        <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
          ...
          <div class="flex justify-center items-center h-full">
            <div class="text-center text-white px-6 md:px-12 w-7/12">
              ...
              <h3 class="text-3xl font-bold mb-8">We are happy to assist you for your medical needs. Create an account to look up your appointments, access medical records, and much more! </h3>
